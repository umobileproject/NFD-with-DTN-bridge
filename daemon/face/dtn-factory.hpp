...
public: // from ProtocolFactory
  ...
  createFace(const FaceUri& uri,
             ...
             bool wantLocalFieldsEnabled, //  added override and this bool otherwise it doesnt override.
             const FaceCreatedCallback& onCreated,
             const FaceCreationFailedCallback& onConnectFailed) override;// DECL_OVERRIDE; //compiler error

  virtual std::vector<shared_ptr<const Channel>>
  getChannels() const override;// DECL_OVERRIDE;
